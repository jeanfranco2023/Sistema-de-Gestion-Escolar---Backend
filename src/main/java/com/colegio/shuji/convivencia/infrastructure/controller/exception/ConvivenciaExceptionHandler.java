package com.colegio.shuji.convivencia.infrastructure.controller.exception;
...
@Order(0)
@RestControllerAdvice(basePackages = "com.colegio.shuji.convivencia.infrastructure.controller.rest")
public class ConvivenciaExceptionHandler {
