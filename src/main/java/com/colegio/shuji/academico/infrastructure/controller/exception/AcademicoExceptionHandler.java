package com.colegio.shuji.academico.infrastructure.controller.exception;
...
@Order(0)
@RestControllerAdvice(basePackages = "com.colegio.shuji.academico.infrastructure.controller.rest")
