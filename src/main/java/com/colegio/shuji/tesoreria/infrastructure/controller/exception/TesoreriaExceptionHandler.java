package com.colegio.shuji.tesoreria.infrastructure.controller.exception;
...
@Order(0)
@RestControllerAdvice(basePackages = "com.colegio.shuji.tesoreria.infrastructure.controller.rest")
public class TesoreriaExceptionHandler {
