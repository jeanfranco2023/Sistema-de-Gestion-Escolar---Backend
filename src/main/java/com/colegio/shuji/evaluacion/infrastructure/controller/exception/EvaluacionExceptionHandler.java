package com.colegio.shuji.evaluacion.infrastructure.controller.exception;
...
@Order(0)
@RestControllerAdvice(basePackages = "com.colegio.shuji.evaluacion.infrastructure.controller.rest")
public class EvaluacionExceptionHandler {
