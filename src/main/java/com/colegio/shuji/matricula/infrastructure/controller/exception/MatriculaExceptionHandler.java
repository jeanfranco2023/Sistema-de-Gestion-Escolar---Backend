package com.colegio.shuji.matricula.infrastructure.controller.exception;
...
@Order(0)
@RestControllerAdvice(basePackages = "com.colegio.shuji.matricula.infrastructure.controller.rest")
