package com.colegio.shuji.comunicado.infrastructure.controller.exception;
...
@Order(0)
@RestControllerAdvice(basePackages = "com.colegio.shuji.comunicado.infrastructure.controller.rest")
